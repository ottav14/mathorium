...
export default function SetTheory() {
	return (
		<div className={styles.notesBody}>
			...
			<div className={styles.notesSectionTitle}>
				Sections
			</div>
			<div className={styles.notesSections}>
				<Link href="set-theory/definitions">Definitions</Link>
				<Link href="set-theory/axioms">Axioms</Link>
				<Link href="set-theory/theorems">Theorems</Link>
			</div>
		</div>
	);
}
